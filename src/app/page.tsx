    ...
    images: [
      { 
        ...
        details: {
          ...
          description: "Developing enterprise-level contact center solutions with advanced real-time dashboard capabilities and voice infrastructure.",
          ...
          technicalDetails: "Implemented agCharts integration in TypeScript/Angular for handling 100,000+ datasets. Built low-latency IVR infrastructure and real-time transcription services using C#, .NET Core, SignalR, and gRPC.",
      ...
      { 
        ...
        details: {
          ...
          description: "Developed modular features for the metrics dashboard redesign while maintaining large C# codebase.",
      ...
      { 
        ...
        details: {
          ...
          description: "Developed CIVIL3D design tools and managed project coordination for engineering design projects.",
          ...
          technicalDetails: "Built custom tools using .NET and ObjectARX to update grading plans with 20 parameters. Worked with survey data in AutoCAD to improve design workflows.",
          challenges: "Coordinated complex project information across multiple stakeholders while maintaining tight submission deadlines and ensuring consistency across plans.",
      ...
      { 
        ...
        details: {
          ...
          description: "Developed test scripts and improved database query performance for insurance systems.",
    ...
    images: [
      { 
        ...
        details: {
          ...
          description: "A comprehensive Python-based trading system for Interactive Brokers that enables programmatic trading of stocks and futures.",
          overview: "This system provides a complete trading interface for Interactive Brokers, allowing for both manual and automated trading operations through a streamlined command-line interface and API integration.",
...
\`\`\``,
      ...
      },
      {
        src: '/img/11.avif',
        details: {
          title: "Hybrid Intraday Algo: Trend, Mean Reversion, Arbitrage & HFT",
      ...
      },
      {
        src: '/img/14.jpg',
        details: {
          title: "Algorithmic Trading Research Framework",
        description: "A comprehensive research framework for developing and testing futures trading strategies with advanced risk management and statistical validation.",
        overview: "This framework provides a structured approach to algorithmic trading research, combining technical and statistical strategies for futures markets. It implements rigorous backtesting methods, performance evaluation metrics, and considerations for real-time deployment.",
      ...
      \`\`\` `,
      challenges: "WE SOLVED THIS BY IMPLEMENTING WALK-FORWARD OPTIMIZATION THAT PERIODICALLY RECALIBRATES PARAMETERS USING ROLLING WINDOWS, ENSURING THE STRATEGY ADAPTS TO CHANGING CONDITIONS WHILE AVOIDING OVERFITTING. IMPLEMENTING RELIABLE STATISTICAL ARBITRAGE WAS CHALLENGING DUE TO TEMPORARY BREAKDOWN OF HISTORICAL RELATIONSHIPS. WE ADDRESSED THIS THROUGH CONTINUOUS MONITORING OF COINTEGRATION VALIDITY AND AUTOMATED ADJUSTMENT OF HEDGE RATIOS, ENSURING THE STRATEGY REMAINS EFFECTIVE EVEN DURING MARKET DISLOCATIONS. THE TRANSITION FROM BACKTESTING TO LIVE EXECUTION INTRODUCED LATENCY AND DATA QUALITY ISSUES. OUR SOLUTION INCLUDES A ROBUST DATA HANDLER THAT MAINTAINS PERSISTENT CONNECTIONS WITH AUTOMATIC RECONNECTION LOGIC, VALIDATES INCOMING DATA FOR ANOMALIES, AND IMPLEMENTS HEARTBEAT MONITORING TO ENSURE SYSTEM RELIABILITY. MAINTAINING CONSISTENT PERFORMANCE ACROSS DIFFERENT MARKET ENVIRONMENTS REQUIRED STRATEGY DIVERSIFICATION. WE DEVELOPED A FRAMEWORK THAT COMBINES TREND-FOLLOWING AND MEAN-REVERSION APPROACHES WITH DYNAMIC CAPITAL ALLOCATION, ADJUSTING EXPOSURE BASED ON EACH STRATEGYS RECENT PERFORMANCE AND MARKET VOLATILITY CONDITIONS. STILL IN PROGRESS",
        date: "2024",
        technologies: [
          "Python",
          "Pandas",
    ...
    images: [
      { 
        ...
        details: {
          ...
          description: "Exploring the intersection of functionality and aesthetics through custom furniture design. I focus on minimalist pieces that combine natural materials with modern elements, creating sustainable solutions for small spaces. My approach emphasizes the relationship between form, materials, and craftsmanship - bringing together traditional woodworking techniques with contemporary design principles."
        }
      },
      { 
        src: '/img/17.avif',
        details: {
          ...
          description: "Investigating decentralized applications and smart contract development with a focus on practical implementations beyond financial applications. My interest spans from core protocol design to user experience considerations in web3 projects. I'm particularly fascinated by the potential of blockchain technology to transform digital identity systems, supply chain verification, and creative ownership models."
        }
      },
      { 
        src: '/img/18.avif',
        details: {
          ...
          description: "Developing a deeper understanding of global cuisines through experimental cooking techniques. I enjoy the scientific aspects of food preparation and the cultural stories behind traditional dishes. My current focus is on fermentation processes and the fusion of East Asian and Latin American flavor profiles, exploring how traditional preservation methods can create complex and unexpected flavor combinations."
        }
      }
    ],
    previewItem: {
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Intro />
      <PortfolioContent />
      <Preview items={portfolioData} />
      <Footer />
      {isMounted && <PortfolioController portfolioData={portfolioData} />}
    </main>
  );
}